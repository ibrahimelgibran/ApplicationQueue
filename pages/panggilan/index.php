...
<body class="d-flex flex-column h-100">
            ...
            <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
                ...
                <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="https://ibrahimelgibran.com/"><i class="bi-house-fill text-success"></i></a></li>
    ...
    <footer class="footer mt-auto py-4">
        <div class="container">
            ...
            &copy; 2024 - <a href="https://ibrahimelgibran.com/" target="_blank" class="text-decoration-none" style="color:#00aa9d">IegCode</a>. All rights reserved.
            </div>
        </div>
    </footer>
